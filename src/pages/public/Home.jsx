        ...
        <div className="container relative py-20 md:py-32">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="text-4xl font-bold tracking-tight text-foreground sm:text-5xl md:text-6xl">
              Connecting Lives, <span className="text-primary">Saving Futures</span>
            </h1>
            ...
            {/* Quotes */}
            <div
              className={`mt-8 p-6 rounded-2xl bg-primary/5 border border-primary/10 transition-opacity duration-500 ${
        ...
        <div className="container">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              Our platform connects patients, donors, hospitals, and NGOs in a seamless ecosystem.
            </p>
          </div>
          ...
          <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {features.map((feature, index) => (
              ...
              >
                <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-primary/10 group-hover:bg-primary">
      ...
      <footer className="border-t border-border bg-muted/30 py-12">
        <div className="container flex flex-col items-center gap-6 sm:flex-row sm:justify-between">
          ...
          <div className="flex gap-4">
            ...
            <Link to="/tribute" className="text-sm hover:text-primary">
              Tributes
            </Link>
